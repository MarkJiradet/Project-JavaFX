...
import com.information.hql.entity.Invoice;
...
public class CartController implements Initializable{
	...
	@FXML
	private TableColumn <Cart,String>col_size;
	@FXML
	...
	public void initialize(URL url,ResourceBundle rb) {
		try {
			...
			col_size.setCellValueFactory(new PropertyValueFactory<Cart,String>("size_c"));
	...
	public void btnPurchase(ActionEvent event) throws IOException {
		...
		try {
			...
			Invoice invoice = new Invoice(Integer.parseInt(label_total.getText()));
	...
	public void btnDelete(ActionEvent event) {
		...
		try {
			...
			Alert a = new Alert(Alert.AlertType.NONE,"ลบ "+c.getName_c()+" ออกจากตะกร้าสำเร็จ",ButtonType.OK);
			a.show();
			initialize(null,null);
			factory.close();
		}
	...
	public void rowClick(MouseEvent event) {
		...
		c = new Cart(click.getId_c(),click.getName_c(),click.getBrand_c(),click.getSize_c(),click.getPrice_c());
	}
