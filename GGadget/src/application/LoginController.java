...
public class LoginController {
	...
	public void btnLogin(ActionEvent event) throws IOException{
		...
		user = session.createQuery("from Member u where u.email_member='"+text_email.getText()+"' AND u.password_member='"+text_password.getText()+"'").list();
		
		if((text_email.getText()).equals("admin@gmail.com")&&(text_password.getText()).equals("admin")) {
